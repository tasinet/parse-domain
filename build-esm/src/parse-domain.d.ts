...
export declare type ParseResultInvalid =
  ParseResultCommon<ParseResultType.Invalid> & {
    /**
...
export declare type ParseResultIp = ParseResultCommon<ParseResultType.Ip> &
  Pick<SanitizationResultValidIp, "ipVersion">;
export declare type ParseResultReserved =
  ParseResultCommon<ParseResultType.Reserved> & ParseResultCommonValidDomain;
export declare type ParseResultNotListed =
...
export declare type ParseResultListed =
  ParseResultCommon<ParseResultType.Listed> &
...
export declare type ParseResult =
  ...
  | ParseResultListed;
export declare const parseDomain: (
