...
const writeTriesToFiles = ({ serializedIcannTrie, serializedPrivateTrie }) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(
      targetDirectories.map((targetDirectory) =>
        __awaiter(void 0, void 0, void 0, function* () {
          const pathToIcannTrie = (0, path_1.resolve)(
            __dirname,
            targetDirectory,
            "icann.json"
          );
          const pathToPrivateTrie = (0, path_1.resolve)(
            __dirname,
            targetDirectory,
            "private.json"
          );
          const pathToTrieInfoFile = (0, path_1.resolve)(
            __dirname,
            targetDirectory,
            "info.json"
          );
...
exports.done = (() =>
  __awaiter(void 0, void 0, void 0, function* () {
    console.warn(
      `Fetching public suffix list from ${config_1.PUBLIC_SUFFIX_URL}...`
    );
    yield writeTriesToFiles(
      yield (0, update_tries_1.fetchBuildSerializeTries)()
    );
  }))();
